...
int main() {
    ...
    auto c1_1 = std::make_unique<Container>("c1-1", "nginx:latest", 2.0, 5120.0);
    auto c1_2 = std::make_unique<Container>("c1-2", "redis:latest", 6.0, 2560.0);
